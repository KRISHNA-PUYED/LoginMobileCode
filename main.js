...
window.addEventListener("DOMContentLoaded", event => {
  document.querySelectorAll(".con")[1].style.display = "none";//none
  document.querySelectorAll(".con")[2].style.display = "none";//none
...
var C_Pro=document.getElementById("C_Pro");
...
C_Pro.addEventListener("click",C_Programs)
